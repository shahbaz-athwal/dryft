...
import { SignInSchemaInfer } from "@repo/schema/sign-in";
export function SignInForm({
  form,
  onSubmit,
}: {
  form: UseFormReturn<SignInSchemaInfer>;
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
      ...
      <Form {...form}>
        <form className="my-8 space-y-4" onSubmit={onSubmit}>
          <FormField
          ...
          <div className="flex flex-col space-y-4">
            <button
              className="cursor-pointer relative group/btn flex space-x-2 items-center justify-center px-4 w-full text-black rounded-md h-10 font-medium shadow-input bg-gray-50 dark:bg-zinc-900 dark:shadow-[0px_0px_1px_1px_var(--neutral-800)]"
              type="button"
            >
